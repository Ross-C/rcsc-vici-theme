...
<body class="nav-md" onkeydown="KeyCode(event)">
  <div class="container body" style="display:none;">
      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="<?php echo $_SERVER['PHP_SELF']; ?>" class="site_title"><i class="fa fa-phone"></i> <span>Dialler Admin</span></a>
          </div>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                ...
                <ul class="dropdown-menu dropdown-usermenu pull-right">
                  ...
                  <li><a href="manager_chat_interface.php"><i class="fa fa-commenting-o pull-right"></i>Chat</a>
                  </li>
            ...
            // vm.loading(false);
                ...
                <script>
                  ...
                  function buildSubMenu(item) {
                    return '<ul class="nav child_menu" >' + item.subMenu.map(function(item) {
                  ...
                  $(document).ready(function() {
                    ...
                    var menus = menuOptions.filter(function(item) {
                      return !item.subHead
                    });
                    ...
                    menus.filter(function(item) {
                      ...
                      item.subMenu = menuOptions.filter(function(item) {
                        return item.subHead
                      });
                    });
                    ...
                    if (noDataTable.indexOf(window.location.href.split('?')[1]) == 1 || url == "default") {
                      ...
                      //////////////////////////////////////
                      var listTable = $(mainTable[CONTENT]).find('table').filter(function() {
                        return $(this).find('input').length < 1;
                      });
    ...
    <!-- /page content -->
    <div id="audio_chooser_span"><a onclick="$('#audio_chooser_span').css({'display': 'none', 'cursor': 'pointer'})">click here or press (ESC) X</a>
      <div></div>
      <load></load>
    </div><!--cuadro de dialogo de algunas pantallas-->
